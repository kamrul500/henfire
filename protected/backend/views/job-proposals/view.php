...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-3">
      ...
      <div class="box box-primary">
        <div class="box-body box-profile">
          <img class="profile-user-img img-responsive img-circle" src="<?=MyHelpers::IdtoPic($jobdetails->user_id);?>" alt="User profile picture">

          <h3 class="profile-username text-center"><?=MyHelpers::IdToFullName($jobdetails->user_id);?></h3>
