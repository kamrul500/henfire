    ...
    <div class="col-md-3">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <hr>
          <strong><i class="fa fa-id-card margin-r-5"></i> <?=Yii::t('backend', 'Skills');?></strong>
          <div class="tag_list">
          <ul class="tags">
    ...
    <div class="col-md-9">
      <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
          <li class="active"><a href="#hourliescreated" data-toggle="tab"><?=Yii::t('backend', 'Hourlies Created');?></a></li>
          <li><a href="#hourlies" data-toggle="tab"><?=Yii::t('backend', 'Hourlies Bought');?></a></li>
          <li><a href="#jobs" data-toggle="tab"><?=Yii::t('backend', 'Jobs Created');?></a></li>
          <li><a href="#jobsgiven" data-toggle="tab"><?=Yii::t('backend', 'Jobs Awarded');?></a></li>
          <li><a href="#proposals" data-toggle="tab"><?=Yii::t('backend', 'Proposals');?></a></li>
          <li><a href="#settings" data-toggle="tab"><?=Yii::t('backend', 'Settings');?></a></li>
        </ul>
        <div class="tab-content">
          <div class="tab-pane active" id="hourliescreated">
            <table id="hourliescreatedtable" class="table table-bordered table-hover">
              <thead>
              <tr>
          ...
          <div class="tab-pane" id="hourlies">
          ...
          <!-- /.tab-pane -->
          <div class="tab-pane" id="jobsgiven">
            <table id="jobsgiventable" class="table table-bordered table-hover">
              <thead>
              <tr>
                <th><?=Yii::t('backend', 'Title');?></th>
                <th><?=Yii::t('backend', 'Status');?></th>
          ...
          <div class="tab-pane" id="settings">
              ...
              <div class="row">
                ...
                <div class="col-xs-3">
                   <?= $form->field($model, 'hourlie_rate')->textInput(['maxlength' => true]) ?>
                </div>
              </div>
              <hr>
              <div class="row">
...
$(document).ready(function() {
    ...
    $('#hourliescreatedtable').DataTable();
    $('#jobsgiventable').DataTable();
    $('#jobtable').DataTable();
