...
$this->title = MyHelpers::HourlieSalesIdtoName($model->job_id);
$this->params['breadcrumbs'][] = ['label' => Yii::t('backend', 'Hourlie workstream'), 'url' => ['/hourlieworkstream']];
    ...
    <div class="col-md-3">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"><?= Yii::t('backend', 'About this Hourlie');?></h3>
        </div>
        <!-- /.box-header -->
        <?=$about;?>
        <!-- /.box-body -->
