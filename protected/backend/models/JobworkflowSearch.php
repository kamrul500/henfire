...
/**
 * JobworkflowSearch represents the model behind the search form about `app\models\Jobworkflow`.
 */
class JobworkflowSearch extends Jobworkflow
{
    /**
     * @inheritdoc
     */
