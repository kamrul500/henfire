...
<?php $model->experience_level = "radio1"; ?>

    <?= $form->field($model, 'experience_level', ['template' => "<div class=\"radio1\">\n{input}\n<label class=\"control-label\" for=\"radio1\"><div class=\"divasradio1 radiochecked\"><div class=\"radiotitle1 text-center\">".Yii::t('frontend','ENTRY LEVEL')."</div><div class=\"radiotext text-center\">".Yii::t('frontend','Basic work at a low rate per hour')."</div><div class=\"levelcurrency\">$entryLevel</div></div></label>\n{error}\n{hint}\n</div>"])->input('radio', ['value' => 1, 'id' => 'radio1', 'uncheck' => null])?>
    </div>
    <div class="col-md-4">
