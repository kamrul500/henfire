...
<div class="wrap">
  <div class="container">
    ...
    NavBar::begin([
        ...
        'options' => [
            'class' => 'navbar-custom-main navbar-fixed-top',
        ],
    ]);

    $menuItems[] = ['label' => Yii::t('frontend', 'Buy'), 'active' => false, 'items' => [

            ['label' => Yii::t('frontend', 'Browse Hourlies'), 'url' => ['/hourlies']],
            ['label' => Yii::t('frontend', 'Post Job'), 'url' => ['/job/new?r=post_new_job']],
            ['label' => Yii::t('frontend', 'Find Freelancers'), 'url' => ['/freelancer']],


        ]];
        $menuItems[] = ['label' => Yii::t('frontend', 'Sell'), 'active' => false, 'items' => [

            ['label' => Yii::t('frontend', 'Browse Jobs'), 'url' => ['/freelance-jobs']],
            ['label' => Yii::t('frontend', 'Post Hourlie'), 'url' => ['/hourlies/create']],
