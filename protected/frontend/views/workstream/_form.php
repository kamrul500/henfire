...
<div class="workstream-form">
    ...
    <?= $form->field($model, 'upload_zip')->textarea(['rows' => 6]) ?>

    <?= $form->field($model, 'user_replied')->textInput() ?>

    <?= $form->field($model, 'freelancer_replied')->textInput() ?>

    <?= $form->field($model, 'is_hourlie')->textInput() ?>

    <?= $form->field($model, 'is_job')->textInput() ?>
