...
/**
 * MyHourliesSearch represents the model behind the search form about `app\models\HourliesSales`.
 */
class MyHourliesSearch extends HourliesSales
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'seller_id', 'buyer_id', 'item_id', 'amount_bought', 'paid_status', 'buyer_cancelled', 'seller_cancelled', 'completed', 'isEscro', 'released_escro', 'complaint', 'is_refunded'], 'integer'],
            [['item_name', 'cost', 'total_cost', 'date_completed', 'buyer_transaction_code', 'payment_type', 'buyer_paypal', 'buyer_paypal_auth', 'seller_paypal', 'buyer_card_vault', 'complaint_message', 'seller_transaction_code', 'custom_trans_id', 'our_commission', 'totalaftercommission', 'sellers_currency', 'buyers_currency', 'origional_currency_price'], 'safe'],
        ];
    }
